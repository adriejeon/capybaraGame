  ...
  List<ThemeItem> _createDefaultThemes() {
    return [
      ThemeItem(
        ...
        imagePath: 'assets/images/main.webp',
        price: 0,
        isPurchased: true,
        isDefault: true,
      ),
      ThemeItem(
        ...
        name: '해변 테마',
        nameEn: 'Beach Theme',
        imagePath: 'assets/theme/beach.webp',
        price: 1000,
        isPurchased: false,
      ),
      ThemeItem(
        ...
        name: '도시 테마',
        nameEn: 'City Theme',
        imagePath: 'assets/theme/city.webp',
        price: 1000,
        isPurchased: false,
      ),
      ThemeItem(
        ...
        name: '온천 테마',
        nameEn: 'Onsen Theme',
        imagePath: 'assets/theme/onsen.webp',
        price: 1000,
        isPurchased: false,
      ),
      ThemeItem(
        ...
        name: '축구 테마',
        nameEn: 'Soccer Theme',
        imagePath: 'assets/theme/soccor.webp',
        price: 1200,
        isPurchased: false,
      ),
      ThemeItem(
        ...
        name: '농장 테마',
        nameEn: 'Farm Theme',
        imagePath: 'assets/theme/farm.webp',
        price: 1200,
        isPurchased: false,
      ),
    ];
