  ...
  static List<DailyMission> createDefaultMissions() {
    return [
      ...
      DailyMission(
        ...
        descriptionKo: '카피바라 게임을 3판 완료하세요.',
        descriptionEn: 'Complete 3 capybara games.',
        targetCount: 3,
        currentCount: 0,
        coinReward: 30,
        isCompleted: false,
      ...
      DailyMission(
        ...
        descriptionKo: '친구에게 오늘 뽑은 카피바라 캐릭터를 2번 공유하세요.',
        descriptionEn: 'Share today\'s drawn capybara character with friends 2 times.',
        targetCount: 2,
        currentCount: 0,
        coinReward: 20,
        isCompleted: false,
